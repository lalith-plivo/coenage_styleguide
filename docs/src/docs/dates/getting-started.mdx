...
- [@cestyle/hooks](https://www.npmjs.com/package/@cestyle/hooks)
- [@cestyle/core](https://www.npmjs.com/package/@cestyle/core)

Install with npm:

```sh
npm install dayjs @cestyle/core @cestyle/hooks @cestyle/dates
```

Install with yarn:

```sh
yarn add dayjs @cestyle/core @cestyle/hooks @cestyle/dates
```

## Localization

CeStyle dates uses [dayjs](https://day.js.org/) library for localization.
...
[CeStyleProvider](/theming/cestyle-provider/) allows you to set a `datesLocale` property for all date components, or you can overwrite the locale on a per component basis:

```tsx
import { DatePicker, Calendar, Month } from '@cestyle/dates';
...
Apart from components @cestyle/dates package also exports several utility functions.
...
```tsx
import { getMonthDays } from '@cestyle/dates';
...
```tsx
import { getMonthsNames } from '@cestyle/dates';
...
```tsx
import { getWeekdaysNames } from '@cestyle/dates';
...
```tsx
import { getYearsRange } from '@cestyle/dates';
...
```tsx
import { isSameDate } from '@cestyle/dates';
...
```tsx
import { isSameMonth } from '@cestyle/dates';
