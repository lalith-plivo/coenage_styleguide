...
import: "import { TimeInput, TimeRangeInput } from '@cestyle/dates';"
source: 'cestyle-dates/src/components/TimeInput/TimeInput.tsx'
docs: 'dates/TimeInput.mdx'
styles: ['TimeInput', 'TimeRangeInput']
---

import { TimeInputDemos, TimeRangeInputDemos } from '@cestyle/demos';
