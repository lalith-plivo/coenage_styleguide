...
import: "import { DatePicker, DateRangePicker } from '@cestyle/dates';"
source: 'cestyle-dates/src/components/DatePicker/DatePicker.tsx'
docs: 'dates/DatePicker.mdx'
styles: ['DatePicker', 'DateRangePicker']
---

import { DatePickerDemos, DateRangePickerDemos } from '@cestyle/demos';
