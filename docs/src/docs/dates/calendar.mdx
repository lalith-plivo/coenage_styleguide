...
import: "import { Calendar, RangeCalendar } from '@cestyle/dates';"
source: 'cestyle-dates/src/components/Calendar/Calendar.tsx'
docs: 'dates/Calendar.mdx'
styles: ['Calendar', 'RangeCalendar']
---

import { CalendarDemos, RangeCalendarDemos } from '@cestyle/demos';
