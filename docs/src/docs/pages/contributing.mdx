---
title: 'Contribute to CeStyle'
---

# Contributing to CeStyle

First of all, thank you for showing interest in contributing to CeStyle, all your contributions are extremely valuable to the project!

## Ways to contribute

- **Improve documentation:** fix incomplete or missing docs, bad wording, examples or explanations
- **Give feedback:** we are constantly working on making CeStyle better, please share how you use CeStyle, what features are missing and what is done good via [GitHub Discussions](https://github.com/cestyledev/cestyle/discussions/new) or [Discord](https://discord.gg/eUZpPbpxb4)
- **Share CeStyle:** share link to CeStyle docs with everyone who can be interested, [share CeStyle on Twitter](https://twitter.com/intent/tweet?text=CeStyle%20%E2%80%93%20new%20React%20library%20with%20100%2B%20components%20and%20hooks.%20It%20has%20native%20dark%20theme%20support%20and%20focuses%20on%20accessibility%20and%20usability.%0A%0Ahttp%3A%2F%2Fcestyle.dev%0A%0A%23reactjs%20)
- **Contribute to codebase:** propose new feature via [GitHub Issues](https://github.com/cestyledev/cestyle/issues/new) or find an [existing one](https://github.com/cestyledev/cestyle/labels/help%20wanted) that you are interested in and work on it
- **Give us a code review:** help us identify problems with [source code](https://github.com/cestyledev/cestyle/tree/master/src) or make CeStyle more performant

## Contributing workflow

- Decide what you want to contribute
- If you want to implement new feature discuss it with maintainer ([GitHub Discussions](https://github.com/cestyledev/cestyle/discussions/new) or [Discord](https://discord.gg/eUZpPbpxb4)) before jumping into code
...
- If you cannot finish your task or changed your mind – that's totally fine, just let us know in GitHub issue that you've created in first step. CeStyle community is friendly – we won't judge or ask any questions if you decide to cancel your submission
- Your PR is merged, you are awesome!

## Commit convention

CeStyle is a monorepo and it is important to write correct commit messages to keep git history clean.
...
- Fork [repository](https://github.com/cestyledev/cestyle), clone or download your fork
...
All npm scripts are located at [main package.json](https://github.com/cestyledev/cestyle/blob/master/package.json),
