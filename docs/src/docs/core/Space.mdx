...
props: ['Space']
import: "import { Space } from '@cestyle/core';"
source: 'cestyle-core/src/components/Space/Space.tsx'
docs: 'core/Space.mdx'
styles: ['Space', 'single-node']
---

import { SpaceDemos } from '@cestyle/demos';
...
In most cases, you would want to use margin props instead of Space when working with CeStyle components:
