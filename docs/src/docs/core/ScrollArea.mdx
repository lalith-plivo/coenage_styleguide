...
props: ['ScrollArea']
styles: ['ScrollArea']
import: "import { ScrollArea } from '@cestyle/core';"
source: 'cestyle-core/src/components/ScrollArea/ScrollArea.tsx'
docs: 'core/ScrollArea.mdx'
---

import { AppShellDemos, ScrollAreaDemos } from '@cestyle/demos';
...
ScrollArea integrates seamlessly with all CeStyle components that can require scrollbars.
