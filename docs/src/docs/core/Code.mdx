...
props: ['Code']
import: "import { Code } from '@cestyle/core';"
source: 'cestyle-core/src/components/Code/Code.tsx'
docs: 'core/Code.mdx'
styles: ['Code', 'single-node']
---

import { CodeDemos, PrismDemos } from '@cestyle/demos';
...
In case you need syntax highlight like in all code examples on CeStyle website,
use [@cestyle/prism](/others/prism/) package:
