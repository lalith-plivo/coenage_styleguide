...
props: ['Notification']
import: "import { Notification } from '@cestyle/core';"
source: 'cestyle-core/src/components/Notification/Notification.tsx'
docs: 'core/Notification.mdx'
styles: ['Notification']
---

import { NotificationDemos } from '@cestyle/demos';

## Usage

Notification is a base component for notification system.
Build your own or use [@cestyle/notifications](/others/notifications/) package.
