...
props: ['Popper']
import: "import { Popper } from '@cestyle/core';"
source: 'cestyle-core/src/components/Popper/Popper.tsx'
docs: 'core/Popper.mdx'
---

import { PopperDemos, TooltipDemos } from '@cestyle/demos';

## Usage

Popper is a utility component used under the hood in [Menu](/core/menu/), [Popover](/core/popover/), [Tooltip](/core/tooltip/)
and other CeStyle components. You can use it to create your own dropdowns and popovers if CeStyle components do not meet your requirements.
...
import { Popper } from '@cestyle/core';
