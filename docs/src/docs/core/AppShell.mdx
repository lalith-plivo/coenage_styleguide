...
import: "import { AppShell, Navbar, Header, Aside, Footer } from '@cestyle/core';"
source: 'cestyle-core/src/components/AppShell/AppShell.tsx'
docs: 'core/AppShell.mdx'
styles: ['AppShell', 'Navbar']
---

import { ExternalLinkIcon } from '@modulz/radix-icons';
import { Anchor, Center } from '@cestyle/core';
import { AppShellDemos } from '@cestyle/demos';

## Usage

AppShell is a layout component that can be used to create a common Header - Navbar - Footer - Aside - Content layout pattern.
AppShell, Header, Footer, Aside and Navbar components include bare minimum default styles to simplify customization. [View full source code](https://github.com/cestyledev/cestyle/tree/master/src/cestyle-demos/src/demos/core/AppShell)
...
Navbar and Aside components can be used outside of AppShell context ([View full source code](https://github.com/cestyledev/cestyle/tree/master/src/cestyle-demos/src/demos/core/AppShell)):
...
To make Navbar or Aside fixed (like in CeStyle docs) set `fixed` and `position` props:
...
`Navbar.Section` and `Aside.Section` components can be used with [ScrollArea](/core/scroll-area/) component ([View full source code](https://github.com/cestyledev/cestyle/tree/master/src/cestyle-demos/src/demos/core/AppShell)):
