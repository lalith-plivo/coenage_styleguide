...
props: ['MediaQuery']
import: "import { MediaQuery } from '@cestyle/core';"
source: 'cestyle-core/src/components/MediaQuery/MediaQuery.tsx'
docs: 'core/MediaQuery.mdx'
styles: ['MediaQuery', 'single-node']
---

import { DEFAULT_THEME } from '@cestyle/core';
import { MediaQueryDemos } from '@cestyle/demos';
...
To change these values wrap your application with CeStyleProvider and set `breakpoints` prop on theme:
...
import { MediaQuery } from '@cestyle/core';
