...
slug: /core/button/
category: 'inputs'
description: 'Render button or link with button styles from cestyle theme'
props: ['Button']
import: "import { Button } from '@cestyle/core';"
source: 'cestyle-core/src/components/Button/Button.tsx'
docs: 'core/Button.mdx'
styles: ['Button']
---

import { ButtonDemos } from '@cestyle/demos';
...
it renders regular button without default browser styles and with CeStyle focus styles:
