...
props: ['Stepper', 'Step']
import: "import { Stepper, Step } from '@cestyle/core';"
source: 'cestyle-core/src/components/Stepper/Stepper.tsx'
docs: 'core/Stepper.mdx'
styles: ['Stepper']
---

import { StepperDemos } from '@cestyle/demos';
...
You can [configure breakpoints](/theming/extend-theme/#breakpoints) in CeStyleProvider or use
...
Loader will replace step icon. You can configure default loader in [CeStyleProvider](/theming/cestyle-provider/).
