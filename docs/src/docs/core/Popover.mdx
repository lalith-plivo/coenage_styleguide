...
props: ['Popover']
import: "import { Popover } from '@cestyle/core';"
source: 'cestyle-core/src/components/Popover/Popover.tsx'
docs: 'core/Popover.mdx'
styles: ['Popover']
---

import { PopoverDemos, PasswordInputDemos } from '@cestyle/demos';
