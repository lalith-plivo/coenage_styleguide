...
props: ['Menu']
import: "import { Menu } from '@cestyle/core';"
source: 'cestyle-core/src/components/Menu/Menu.tsx'
docs: 'core/Menu.mdx'
styles: ['Menu']
---

import { MenuDemos } from '@cestyle/demos';
...
```tsx
import { Menu, Text } from '@cestyle/core';
...
<Menu.Item component="a" href="https://cestyle/dev" target="_blank" />
...
```tsx
import { Menu } from '@cestyle/core';
import { NextLink } from '@cestyle/next';
