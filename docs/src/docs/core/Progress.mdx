...
props: ['Progress']
import: "import { Progress } from '@cestyle/core';"
source: 'cestyle-core/src/components/Progress/Progress.tsx'
docs: 'core/Progress.mdx'
styles: ['Progress']
---

import { ProgressDemos, PasswordInputDemos } from '@cestyle/demos';
