...
props: ['Grid']
import: "import { Grid } from '@cestyle/core';"
source: 'cestyle-core/src/components/Grid/Grid.tsx'
docs: 'core/Grid.mdx'
styles: ['Grid', 'single-node']
---

import { GridDemos } from '@cestyle/demos';
...
You can configure breakpoint values in [CeStyleProvider](/theming/extend-theme/#breakpoints).
