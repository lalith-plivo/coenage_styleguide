...
import: "import { SegmentedControl } from '@cestyle/core';"
source: 'cestyle-core/src/components/SegmentedControl/SegmentedControl.tsx'
docs: 'core/SegmentedControl.mdx'
styles: ['SegmentedControl']
---

import { SegmentedControlDemos } from '@cestyle/demos';
