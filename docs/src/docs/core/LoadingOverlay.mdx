...
import: "import { LoadingOverlay } from '@cestyle/core';"
source: 'cestyle-core/src/components/LoadingOverlay/LoadingOverlay.tsx'
docs: 'core/LoadingOverlay.mdx'
styles: ['LoadingOverlay', 'single-node']
---

import { LoadingOverlayDemos } from '@cestyle/demos';
...
```tsx
import { LoadingOverlay } from '@cestyle/core';
