...
import: "import { Avatar, AvatarsGroup } from '@cestyle/core';"
source: 'cestyle-core/src/components/Avatar/Avatar.tsx'
docs: 'core/Avatar.mdx'
styles: ['Avatar', 'AvatarsGroup']
---

import { AvatarDemos } from '@cestyle/demos';
