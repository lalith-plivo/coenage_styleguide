...
props: ['Transition']
import: "import { Transition, GroupedTransition } from '@cestyle/core';"
source: 'cestyle-core/src/components/Transition/Transition.tsx'
docs: 'core/Transition.mdx'
---

import { TooltipDemos, TransitionDemos } from '@cestyle/demos';
...
CeStyle includes several premade transitions:
...
```tsx
import { Transition } from '@cestyle/core';
...
```tsx
import { GroupedTransition } from '@cestyle/core';
