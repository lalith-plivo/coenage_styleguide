...
import: "import { Dropzone, FullScreenDropzone } from '@cestyle/dropzone';"
source: 'cestyle-dropzone/src'
docs: 'others/dropzone.mdx'
installation: '@cestyle/dropzone'
license: MIT
...
} from '@cestyle/dropzone';
import { DropzoneDemos } from '@cestyle/demos';
...
To save some research time you can use `MIME_TYPES` variable exported from `@cestyle/dropzone`:

```tsx
import { Dropzone, MIME_TYPES } from '@cestyle/dropzone';
...
```tsx
import { IMAGE_MIME_TYPE, Dropzone } from '@cestyle/dropzone';
