...
import: "import { ModalsProvider } from '@cestyle/modals';"
source: 'cestyle-modals/src'
docs: 'others/modals.mdx'
installation: '@cestyle/modals'
license: MIT
---

import { ModalsDemos } from '@cestyle/demos';
...
```sh
npm install @cestyle/modals @cestyle/core @cestyle/hooks
```

Install with yarn:

```sh
yarn add @cestyle/modals @cestyle/core @cestyle/hooks
```
...
import { ModalsProvider } from '@cestyle/modals';
...
@cestyle/modals package includes special modal that can be used for confirmations.
...
```tsx
import { ContextModalProps, ModalsProvider } from '@cestyle/modals';
