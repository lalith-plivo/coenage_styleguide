...
import: "import { RichTextEditor } from '@cestyle/rte';"
source: 'cestyle-rte/src'
docs: 'others/rte.mdx'
installation: '@cestyle/rte'
license: MIT
...
Package has peer dependencies: [react](https://www.npmjs.com/package/react), [react-dom](https://www.npmjs.com/package/react-dom), [@cestyle/hooks](https://www.npmjs.com/package/@cestyle/hooks) and [@cestyle/core](https://www.npmjs.com/package/@cestyle/core):.

Install with npm:

```sh
npm install @cestyle/rte @cestyle/core @cestyle/hooks
```

Install with yarn:

```sh
yarn add @cestyle/rte @cestyle/core @cestyle/hooks
```
...
- `stickyOffset` – top property, used with sticky position, use it to offset elements with fixed position, for example, CeStyle docs website has 60px header, in this case you should set stickyOffset to 60
...
import { RichTextEditor, Editor } from '@cestyle/rte';
...
export default dynamic(() => import('@cestyle/rte'), {
