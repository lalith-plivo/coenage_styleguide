...
import: "import { useOs } from '@cestyle/hooks';"
docs: 'hooks/use-os.mdx'
source: 'cestyle-hooks/src/use-os/use-os.ts'
---
...
You can import `OS` union type from `@cestyle/hooks`:

```tsx
import type { OS } from '@cestyle/hooks';
