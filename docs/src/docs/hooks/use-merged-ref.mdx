...
import: "import { useMergedRef } from '@cestyle/hooks';"
docs: 'hooks/use-merged-ref.mdx'
source: 'cestyle-hooks/src/use-merged-ref/use-merged-ref.ts'
---
...
```tsx
import { useRef } from 'react';
import { useClickOutside, mergeRefs } from '@cestyle/hooks';
