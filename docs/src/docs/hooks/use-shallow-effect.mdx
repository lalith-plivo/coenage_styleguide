...
import: "import { useShallowEffect } from '@cestyle/hooks';"
docs: 'hooks/use-shallow-effect.mdx'
source: 'cestyle-hooks/src/use-shallow-effect/use-shallow-effect.ts'
---
...
import { useShallowEffect } from '@cestyle/hooks';
