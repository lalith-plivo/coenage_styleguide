...
import: "import { useReducedMotion } from '@cestyle/hooks';"
docs: 'hooks/use-reduced-motion.mdx'
source: 'cestyle-hooks/src/use-reduced-motion/use-reduced-motion.ts'
---
...
All CeStyle components which use animations support it by default:
