...
import: "import { useId } from '@cestyle/hooks';"
docs: 'hooks/use-id.mdx'
source: 'cestyle-hooks/src/use-id/use-id.ts'
---
...
```tsx
import { useId } from '@cestyle/hooks';
...
// input and label will have random id 'cestyle-fZMoF'
