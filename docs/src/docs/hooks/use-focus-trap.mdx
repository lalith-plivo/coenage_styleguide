...
import: "import { useFocusTrap } from '@cestyle/hooks';"
docs: 'hooks/use-focus-trap.mdx'
source: 'cestyle-hooks/src/use-focus-trap/use-focus-trap.ts'
---

import { ModalDemos, MenuDemos } from '@cestyle/demos';
...
```tsx
import { useFocusTrap } from '@cestyle/hooks';
...
import { useClickOutside, useFocusTrap, useMergedRef } from '@cestyle/hooks';
...
use-focus-trap is used in some CeStyle components: [Modal](/core/modal/), [Drawer](/core/drawer/), [Menu](/core/menu/) and others.
