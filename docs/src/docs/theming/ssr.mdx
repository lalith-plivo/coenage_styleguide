...
1. Install `@cestyle/ssr` package

```bash
yarn add @cestyle/ssr

npm install @cestyle/ssr
```

2. Create `App` component with `CeStyleProvider`
...
export function App() {
  return (
    {/* Setup CeStyleProvider with your theme */}
