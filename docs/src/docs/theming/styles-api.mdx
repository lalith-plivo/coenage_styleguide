...
import { Slider as SliderStylesApi, Button as ButtonStylesApi } from '@cestyle/styles-api';

# Styles API

All CeStyle components support styling of each component part with inline styles or by passing classes.
...
```tsx
import { Slider, createStyles } from '@cestyle/core';
...
## Styles API with CeStyleProvider

You can also use Styles API in CeStyleProvider with `styles` prop.
