...
import { CustomSelectDemo, CountriesSelect } from '@cestyle/demos';
import { DatePicker, DateRangePicker } from '@cestyle/dates';
...
export function InputsDemo() {
  ...
  return (
    <Paper className={classes.wrapper} shadow="md" p={30}>
