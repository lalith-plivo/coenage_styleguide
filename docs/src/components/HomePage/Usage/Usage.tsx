...
export function Usage() {
  ...
  return (
    <PageSection
      title="Use anywhere"
      description="CeStyle works in all modern environments – get started instantly with Next.js, Gatsby.js, create-react-app, Vite or Remix by following getting started guide:"
    >
      <SimpleGrid
        cols={5}
        mt={30}
