...
import { Text, SimpleGrid, Slider, Button } from '@cestyle/core';
import { Prism } from '@cestyle/prism';
import { Slider as SliderStylesApi } from '@cestyle/styles-api';
...
export function Customize() {
  return (
    <PageSection
      ...
      description="Each CeStyle component supports styles overriding for every internal element inside with classes or inline styles. This feature alongside other customization options allows you to implement any visual modifications to components and adapt them to fit almost any design requirements."
    >
      <SimpleGrid cols={2} breakpoints={[{ maxWidth: 960, cols: 1 }]} spacing={30} mt={30}>
        <div>
          <Text mb={15} weight="semibold" size="lg">
          ...
          <Text mb={15} mt={30} weight="semibold" size="lg">
        ...
        <div>
          <Text mb={20} weight="semibold" size="lg">
