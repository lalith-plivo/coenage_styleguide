...
const REPO_BASE = 'https://github.com/cestyledev/cestyle/blob/master';
    ...
    <div className={classes.wrapper}>
      <div className={cx(classes.header, { [classes.withTabs]: hasTabs })}>
        ...
        {frontmatter.package && (
          ...
          >
            {frontmatter.package.replace('cestyle-', '@cestyle/')}
          </LinkItem>
        )}
        ...
        {frontmatter.license && (
          <LinkItem
            ...
            link="https://github.com/cestyledev/cestyle/blob/master/LICENSE"
          >
            MIT
          </LinkItem>
        )}
