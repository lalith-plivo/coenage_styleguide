...
import { useUncontrolled, useMergedRef, upperFirst } from '@cestyle/hooks';
import { useCeStyleTheme, useCeStyleDefaultProps } from '@cestyle/core';
...
export const DateRangePicker = forwardRef<HTMLInputElement, DateRangePickerProps>(
  (props: DateRangePickerProps, ref) => {
    const {
      ...
      weekendDays,
      ...others
    } = useCeStyleDefaultProps('DateRangePicker', defaultProps, props);
...
DateRangePicker.displayName = '@cestyle/dates/DateRangePicker';
