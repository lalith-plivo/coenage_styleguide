...
describe('@cestyle/core/Month/Day', () => {
  ...
  it('sets data-cestyle-stop-propagation attribute', () => {
    render(<Day {...defaultProps} />);
    expect(screen.getByRole('button')).toHaveAttribute('data-cestyle-stop-propagation', 'true');
  });
  ...
  it('has correct displayName', () => {
    expect(Day.displayName).toStrictEqual('@cestyle/core/Day');
  });
