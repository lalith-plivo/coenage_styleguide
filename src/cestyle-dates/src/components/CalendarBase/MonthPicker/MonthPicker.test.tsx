...
import { itSupportsClassName, checkAccessibility } from '@cestyle/tests';
import userEvent from '@testing-library/user-event';
import { MonthPicker, MonthPickerProps } from './MonthPicker';

const CONTROL_SELECTOR = '.cestyle-MonthPicker-monthPickerControl';
const ACTIVE_CONTROL_SELECTOR = '.cestyle-MonthPicker-monthPickerControlActive';
const LEVEL_SELECTOR = '.cestyle-MonthPicker-calendarHeaderLevel';
const HEADER_CONTROL_SELECTOR = '.cestyle-MonthPicker-calendarHeaderControl';
...
describe('@cestyle/core/MonthPicker', () => {
  ...
  it('has correct displayName', () => {
    expect(MonthPicker.displayName).toStrictEqual('@cestyle/dates/MonthPicker');
  });
});
