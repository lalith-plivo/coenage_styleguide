...
describe('@cestyle/dates/MonthsList', () => {
  checkAccessibility([
  ...
  it('calls onNextLevel when level label is clicked', () => {
    ...
    userEvent.click(container.querySelector('.cestyle-MonthsList-calendarHeaderLevel'));
  ...
  it('renders correct amount of months', () => {
    ...
    expect(two.querySelectorAll('.cestyle-MonthsList-month')).toHaveLength(2);
    expect(three.querySelectorAll('.cestyle-MonthsList-month')).toHaveLength(3);
    expect(four.querySelectorAll('.cestyle-MonthsList-month')).toHaveLength(4);
  });

  it('has correct displayName', () => {
    expect(MonthsList.displayName).toStrictEqual('@cestyle/dates/MonthsList');
  });
});
