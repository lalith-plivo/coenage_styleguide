...
const LEVEL_ICON_SELECTOR = '.cestyle-CalendarHeader-calendarHeaderLevelIcon';

describe('@cestyle/dates/CalendarHeader', () => {
  ...
  it('has correct displayName', () => {
    expect(CalendarHeader.displayName).toStrictEqual('@cestyle/dates/CalendarHeader');
  });
});
