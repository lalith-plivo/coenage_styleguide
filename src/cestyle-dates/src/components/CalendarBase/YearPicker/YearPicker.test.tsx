...
const CONTROL_SELECTOR = '.cestyle-YearPicker-yearPickerControl';
const ACTIVE_CONTROL_SELECTOR = '.cestyle-YearPicker-yearPickerControlActive';

describe('@cestyle/dates/YearPicker', () => {
  ...
  it('has correct displayName', () => {
    expect(YearPicker.displayName).toStrictEqual('@cestyle/dates/YearPicker');
  });
});
