...
import { useDisclosure } from '@cestyle/hooks';
import { CE_STYLES_SIZES, CeStyleProvider, TextInput, Modal, Button } from '@cestyle/core';
import { WithinOverlays, SubmitForm } from '@cestyle/storybook';
...
storiesOf('DatePicker', module)
  ...
  .add('Date format on CeStyleProvider', () => (
    <CeStyleProvider theme={{ dateFormat: 'MM YYYY DD' }}>
