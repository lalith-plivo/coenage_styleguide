...
import { useCeStyleDefaultProps } from '@cestyle/core';
...
export const RangeCalendar = forwardRef<HTMLDivElement, RangeCalendarProps>(
  (props: RangeCalendarProps, ref) => {
    const {
      ...
      amountOfMonths,
      ...others
    } = useCeStyleDefaultProps('RangeCalendar', defaultProps, props);
...
RangeCalendar.displayName = '@cestyle/dates/RangeCalendar';
