...
import { Tooltip, Button, ActionIcon, Text, Box, useCeStyleTheme } from '@cestyle/core';

const code = `
import { useState } from 'react';
import { Tooltip, Button, ActionIcon, Text, useCeStyleTheme } from '@cestyle/core';
import { X } from 'tabler-icons-react';
...
export const pointerEvents: CeStyleDemo = {
  type: 'demo',
  code,
  component: Demo,
};
