...
import { LoadingOverlay, Button, Group, useCeStyleTheme, DEFAULT_THEME } from '@cestyle/core';
import { AuthenticationForm } from '../../../shared/AuthenticationForm/AuthenticationForm';
import { demoBase } from './_demo-base';

const code = `
import { DEFAULT_THEME, LoadingOverlay } from '@cestyle/core';
...
export const loader: CeStyleDemo = {
  ...demoBase,
  type: 'demo',
  code,
  component: Demo,
