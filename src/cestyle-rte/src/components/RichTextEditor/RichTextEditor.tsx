...
import { useUuid, mergeRefs } from '@cestyle/hooks';
...
export const RichTextEditor = forwardRef<Editor, RichTextEditorProps>(
  (props: RichTextEditorProps, ref) => {
    const {
      ...
      ...others
    } = useCeStyleDefaultProps('RichTextEditor', defaultProps, props);
...
RichTextEditor.displayName = '@cestyle/rte/RichTextEditor';
