...
export function FullScreenDropzone(props: FullScreenDropzoneProps) {
  const {
    ...
    children,
    ...others
  } = useCeStyleDefaultProps('FullScreenDropzone', defaultProps, props);
...
FullScreenDropzone.displayName = '@cestyle/dropzone/FullScreenDropzone';
