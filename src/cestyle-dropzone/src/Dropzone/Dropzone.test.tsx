...
describe('@cestyle/dropzone/Dropzone', () => {
  itSupportsSystemProps({
    component: Dropzone,
    props: defaultProps,
    displayName: '@cestyle/dropzone/Dropzone',
  ...
  it('displays LoadingOverlay based on loading prop', () => {
    ...
    expect(loading.querySelectorAll('.cestyle-LoadingOverlay-root')).toHaveLength(1);
    expect(notLoading.querySelectorAll('.cestyle-LoadingOverlay-root')).toHaveLength(0);
  });
