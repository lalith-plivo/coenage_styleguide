...
import { Text, Container, Divider, createStyles, CeStyleProvider } from '@cestyle/core';
import * as StylesAPI from '@cestyle/styles-api';
...
export function StylesAPIStory({
  ...
  return (
    <Container py={withPadding ? 20 : 0} size={maxWidth}>
      ...
      <Section name="CeStyleProvider styles">
        <CeStyleProvider styles={{ [name]: styles }}>
          <Component {...props} />
        </CeStyleProvider>
      </Section>
    </Container>
