...
export function variant(theme: CeStyleThemeBase) {
  ...
  return ({ variant, color, gradient }: VariantInput): VariantOutput => {
    ...
    //  This Code block has new styles added for Coengage Style
    if (variant === 'info') {
      return {
        border: theme.colorScheme === 'dark' ? theme.colors.info[1] : theme.colors.info[1],
        background: theme.colorScheme === 'dark' ? theme.colors.info[0] : theme.colors.info[0],
        color: theme.colorScheme === 'dark' ? theme.colors.info[1] : theme.colors.info[1],
        hover: theme.colorScheme === 'dark' ? theme.colors.info[0] : theme.colors.info[0],
      };
    }
    if (variant === 'success') {
      return {
        border: theme.colorScheme === 'dark' ? theme.colors.success[1] : theme.colors.success[1],
        background:
          theme.colorScheme === 'dark' ? theme.colors.success[0] : theme.colors.success[0],
        color: theme.colorScheme === 'dark' ? theme.colors.success[1] : theme.colors.success[1],
        hover: theme.colorScheme === 'dark' ? theme.colors.success[0] : theme.colors.success[0],
      };
    }
    if (variant === 'warning') {
      return {
        border: theme.colorScheme === 'dark' ? theme.colors.warning[1] : theme.colors.warning[1],
        background:
          theme.colorScheme === 'dark' ? theme.colors.warning[0] : theme.colors.warning[0],
        color: theme.colorScheme === 'dark' ? theme.colors.warning[1] : theme.colors.warning[1],
        hover: theme.colorScheme === 'dark' ? theme.colors.warning[0] : theme.colors.warning[0],
      };
    }
    if (variant === 'danger') {
      return {
        border: theme.colorScheme === 'dark' ? theme.colors.danger[1] : theme.colors.danger[1],
        background: theme.colorScheme === 'dark' ? theme.colors.danger[0] : theme.colors.danger[0],
