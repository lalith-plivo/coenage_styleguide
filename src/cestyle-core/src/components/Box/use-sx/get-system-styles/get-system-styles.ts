import { CeStyleStyleSystemProps, CeStyleTheme, CSSObject } from '@cestyle/styles';
...
function getSizeValue(margin: any, theme: CeStyleTheme) {
...
export function getSystemStyles(systemStyles: CeStyleStyleSystemProps, theme: CeStyleTheme) {
