...
import { PolymorphicComponentProps, PolymorphicRef, useCeStyleDefaultProps } from '@cestyle/styles';
...
export const Card: CardComponent = forwardRef(
  (props: CardProps<'div'>, ref: PolymorphicRef<'div'>) => {
    const { component, className, p, children, classNames, styles, ...others } =
      useCeStyleDefaultProps('Card', defaultProps, props);
...
Card.displayName = '@cestyle/core/Card';
