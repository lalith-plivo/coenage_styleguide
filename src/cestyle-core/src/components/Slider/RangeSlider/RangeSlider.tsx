...
import { useMove, useUncontrolled, useMergedRef } from '@cestyle/hooks';
import {
  DefaultProps,
  CeStyleNumberSize,
  CeStyleColor,
...
import { CeStyleTransition } from '../../Transition';
...
export interface RangeSliderProps
  ...
  labelTransition?: CeStyleTransition;
...
export const RangeSlider = forwardRef<HTMLDivElement, RangeSliderProps>(
  (props: RangeSliderProps, ref) => {
    const {
      ...
      disabled,
      ...others
    } = useCeStyleDefaultProps('RangeSlider', defaultProps, props);
...
RangeSlider.displayName = '@cestyle/core/RangeSlider';
