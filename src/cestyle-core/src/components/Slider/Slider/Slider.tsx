...
import { clamp, useMergedRef, useMove, useUncontrolled } from '@cestyle/hooks';
import {
  DefaultProps,
  CeStyleColor,
  CeStyleNumberSize,
...
export const Slider = forwardRef<HTMLDivElement, SliderProps>((props: SliderProps, ref) => {
  const {
    ...
    disabled,
    ...others
  } = useCeStyleDefaultProps('Slider', defaultProps, props);
...
Slider.displayName = '@cestyle/core/Slider';
