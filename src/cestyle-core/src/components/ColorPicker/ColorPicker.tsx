...
import { useUncontrolled, useDidUpdate } from '@cestyle/hooks';
import { DefaultProps, CeStyleSize, Selectors, useCeStyleDefaultProps } from '@cestyle/styles';
import { Box } from '../Box';
...
export const ColorPicker = forwardRef<HTMLDivElement, ColorPickerProps>(
  (props: ColorPickerProps, ref) => {
    const {
      ...
      classNames,
      ...others
    } = useCeStyleDefaultProps('ColorPicker', defaultProps, props);
...
ColorPicker.displayName = '@cestyle/core/ColorPicker';
