...
const getRightSection = (container: HTMLElement) =>
  container.querySelector('.cestyle-NumberInput-rightSection');

const clickIncrement = (container: HTMLElement) =>
  userEvent.click(container.querySelector('.cestyle-NumberInput-controlUp'));

const clickDecrement = (container: HTMLElement) =>
  userEvent.click(container.querySelector('.cestyle-NumberInput-controlDown'));
...
describe('@cestyle/core/NumberInput', () => {
  checkAccessibility([
  ...
  itSupportsSystemProps({
    ...
    props: defaultProps,
    displayName: '@cestyle/core/NumberInput',
