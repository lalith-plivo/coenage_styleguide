...
import { useUncontrolled, useDidUpdate, useUuid } from '@cestyle/hooks';
import {
  DefaultProps,
  Selectors,
  extractSystemStyles,
...
export const ColorInput = forwardRef<HTMLInputElement, ColorInputProps>(
  (props: ColorInputProps, ref) => {
    const {
      ...
      descriptionProps,
      ...others
    } = useCeStyleDefaultProps('ColorInput', defaultProps, props);
...
ColorInput.displayName = '@cestyle/core/ColorInput';
