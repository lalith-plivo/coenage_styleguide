...
import { DefaultProps, Selectors, useCeStyleTheme, useCeStyleDefaultProps } from '@cestyle/styles';
import { Box } from '../Box';
...
export const ScrollArea = forwardRef<HTMLDivElement, ScrollAreaProps>(
  (props: ScrollAreaProps, ref) => {
    const {
      ...
      ...others
    } = useCeStyleDefaultProps('ScrollArea', defaultProps, props);
...
ScrollArea.displayName = '@cestyle/core/ScrollArea';
