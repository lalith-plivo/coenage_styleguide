...
import { extractSystemStyles, DefaultProps, useCeStyleDefaultProps } from '@cestyle/styles';
import { Box } from '../Box';
...
export function Collapse(props: CollapseProps) {
  const {
    ...
    animateOpacity,
    ...others
  } = useCeStyleDefaultProps('Collapse', defaultProps, props);
...
Collapse.displayName = '@cestyle/core/Collapse';
