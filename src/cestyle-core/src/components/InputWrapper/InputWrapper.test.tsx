...
const queries = {
  getLabel: (container: HTMLElement) => container.querySelector('.cestyle-InputWrapper-label'),
  getError: (container: HTMLElement) => container.querySelector('.cestyle-InputWrapper-error'),
  getRequired: (container: HTMLElement) =>
    container.querySelector('.cestyle-InputWrapper-required'),
  getDescription: (container: HTMLElement) =>
    container.querySelector('.cestyle-InputWrapper-description'),
};

describe('@cestyle/core/InputWrapper', () => {
  itRendersChildren(InputWrapper, defaultProps);
  itSupportsSystemProps({
    component: InputWrapper,
    props: defaultProps,
    displayName: '@cestyle/core/InputWrapper',
