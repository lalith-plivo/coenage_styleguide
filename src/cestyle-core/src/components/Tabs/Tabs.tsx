...
import { useUncontrolled, clamp } from '@cestyle/hooks';
import {
  DefaultProps,
  CeStyleNumberSize,
  CeStyleColor,
...
export const Tabs: TabsComponent = forwardRef<HTMLDivElement, TabsProps>(
  (props: TabsProps, ref) => {
    const {
      ...
      orientation,
      ...others
    } = useCeStyleDefaultProps('Tabs', defaultProps, props);
...
Tabs.displayName = '@cestyle/core/Tabs';
Tabs.Tab = TabControl;
