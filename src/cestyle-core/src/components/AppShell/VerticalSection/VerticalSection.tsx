...
import { DefaultProps, getDefaultZIndex, Global } from '@cestyle/styles';
import { Box } from '../../Box';
    ...
    return (
      ...
      >
        ...
        <Global
          styles={() => ({
            ':root': {
              [`--cestyle-${section}-height`]: `${height}px`,
            },
          })}
        />
      </Box>
...
VerticalSection.displayName = '@cestyle/core/VerticalSection';
