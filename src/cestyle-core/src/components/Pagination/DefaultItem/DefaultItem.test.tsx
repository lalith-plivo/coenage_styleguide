...
import { itSupportsClassName, itSupportsOthers, itSupportsStyle } from '@cestyle/tests';
...
describe('@cestyle/core/Pagination/DefaultItem', () => {
  ...
  it('has correct displayName', () => {
    expect(DefaultItem.displayName).toStrictEqual('@cestyle/core/Pagination/DefaultItem');
  });
});
