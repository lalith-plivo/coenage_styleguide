...
import { CeStyleNumberSize, CSSObject, useCeStyleDefaultProps } from '@cestyle/styles';
...
export function MediaQuery(props: MediaQueryProps) {
  const { children, smallerThan, largerThan, query, styles, className } = useCeStyleDefaultProps(
    'MediaQuery',
    {},
    props
  );
...
MediaQuery.displayName = '@cestyle/core/MediaQuery';
