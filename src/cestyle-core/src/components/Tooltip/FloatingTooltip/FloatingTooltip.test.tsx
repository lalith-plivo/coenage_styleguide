...
import { itRendersChildren, itSupportsSystemProps, renderWithAct, actAsync } from '@cestyle/tests';
...
describe('@cestyle/core/FloatingTooltip', () => {
  ...
  itSupportsSystemProps({
    ...
    props: defaultProps,
    displayName: '@cestyle/core/FloatingTooltip',
