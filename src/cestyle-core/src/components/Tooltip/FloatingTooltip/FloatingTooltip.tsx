...
import { useMergedRef, useMouse } from '@cestyle/hooks';
import { Box } from '../../Box';
import { CeStyleTransition, Transition } from '../../Transition';
...
export const FloatingTooltip = forwardRef<HTMLDivElement, FloatingTooltipProps>(
  (props: FloatingTooltipProps, ref) => {
    const {
      ...
      onMouseEnter,
      ...others
    } = useCeStyleDefaultProps('FloatingTooltip', defaultProps, props);
...
FloatingTooltip.displayName = '@cestyle/core/FloatingTooltip';
