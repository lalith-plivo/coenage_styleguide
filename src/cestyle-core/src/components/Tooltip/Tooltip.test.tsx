...
describe('@cestyle/core/Tooltip', () => {
  ...
  itSupportsSystemProps({
    component: Tooltip,
    props: defaultProps,
    displayName: '@cestyle/core/Tooltip',
  ...
  it('sets body width based on prop', async () => {
    ...
    expect(container.querySelector('.cestyle-Tooltip-body')).toHaveStyle({ width: '164px' });
  });
  ...
  it('sets body pointer-events style based on allowPointerEvents prop', async () => {
    ...
    expect(allow.querySelector('.cestyle-Tooltip-body')).toHaveStyle({ pointerEvents: 'all' });
    expect(disallow.querySelector('.cestyle-Tooltip-body')).toHaveStyle({ pointerEvents: 'none' });
  });
  ...
  it('sets body white-space style based on wrapLines prop', async () => {
    ...
    expect(wrap.querySelector('.cestyle-Tooltip-body')).toHaveStyle({ whiteSpace: 'normal' });
    expect(noWrap.querySelector('.cestyle-Tooltip-body')).toHaveStyle({ whiteSpace: 'nowrap' });
  });
});
