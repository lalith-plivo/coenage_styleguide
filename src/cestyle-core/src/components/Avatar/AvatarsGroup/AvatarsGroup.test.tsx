...
describe('@cestyle/core/AvatarsGroup', () => {
  itSupportsSystemProps({
    component: AvatarsGroup,
    props: defaultProps,
    displayName: '@cestyle/core/AvatarsGroup',
  ...
  it('renders avatars based on limit prop', () => {
    ...
    expect(limit2.querySelectorAll('.cestyle-Avatar-root')).toHaveLength(3);
    expect(limit3.querySelectorAll('.cestyle-Avatar-root')).toHaveLength(4);
    expect(limit10.querySelectorAll('.cestyle-Avatar-root')).toHaveLength(4);
  });
