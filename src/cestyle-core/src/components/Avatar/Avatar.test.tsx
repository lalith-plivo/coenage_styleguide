...
import { checkAccessibility, itIsPolymorphic, itSupportsSystemProps } from '@cestyle/tests';
...
describe('@cestyle/core/Avatar', () => {
  ...
  itSupportsSystemProps({
    component: Avatar,
    props: defaultProps,
    displayName: '@cestyle/core/Avatar',
  ...
  it('renders placeholder if src was not provided', () => {
    ...
    expect(container.querySelector('.cestyle-Avatar-placeholder')).toBeInTheDocument();
  });
