...
import { useScrollLock, useFocusTrap, useFocusReturn } from '@cestyle/hooks';
import {
  DefaultProps,
  CeStyleNumberSize,
  CeStyleShadow,
...
import { GroupedTransition, CeStyleTransition } from '../Transition';
...
export interface DrawerProps
  extends Omit<DefaultProps<DrawerStylesNames>, CeStyleStyleSystemSize>,
...
const transitions: Record<DrawerPosition, CeStyleTransition> = {
  top: 'slide-down',
  bottom: 'slide-up',
  left: 'slide-right',
  right: 'slide-left',
...
const rtlTransitions: Record<DrawerPosition, CeStyleTransition> = {
  top: 'slide-down',
  bottom: 'slide-up',
  right: 'slide-right',
  left: 'slide-left',
...
export function Drawer(props: DrawerProps) {
  const {
    ...
    overlayBlur,
    ...others
  } = useCeStyleDefaultProps('Drawer', defaultProps, props);
          ...
          >
            <Paper<'div'>
              ...
              onKeyDownCapture={(event) => {
                const shouldTrigger =
                  (event.target as any)?.getAttribute('data-cestyle-stop-propagation') !== 'true';
...
Drawer.displayName = '@cestyle/core/Drawer';
