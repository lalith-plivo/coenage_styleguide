...
describe('@cestyle/core/Drawer', () => {
  ...
  it('allows to hide close button with withCloseButton={false} prop', () => {
    ...
    expect(withoutCloseButton.querySelectorAll('.cestyle-Drawer-closeButton')).toHaveLength(0);
    expect(withCloseButton.querySelectorAll('.cestyle-Drawer-closeButton')).toHaveLength(1);
  });

  it('has correct displayName', () => {
    expect(Drawer.displayName).toStrictEqual('@cestyle/core/Drawer');
  });
});
