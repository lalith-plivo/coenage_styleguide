...
describe('@cestyle/core/Chip', () => {
  ...
  it('displays checked icon when input is checked', () => {
    ...
    expect(checked.querySelectorAll('.cestyle-Chip-checkIcon')).toHaveLength(1);
    expect(notChecked.querySelectorAll('.cestyle-Chip-checkIcon')).toHaveLength(0);
  });
