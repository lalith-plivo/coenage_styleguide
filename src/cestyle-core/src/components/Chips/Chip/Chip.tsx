...
import { useUncontrolled, useUuid } from '@cestyle/hooks';
import {
  DefaultProps,
  CeStyleNumberSize,
  CeStyleSize,
...
export interface ChipProps
  ...
  /** Active color from theme, defaults to info */
...
export const Chip = forwardRef<HTMLInputElement, ChipProps>((props: ChipProps, ref) => {
  const {
    ...
    wrapperProps,
    ...others
  } = useCeStyleDefaultProps('Chip', defaultProps, props);
...
Chip.displayName = '@cestyle/core/Chip';
