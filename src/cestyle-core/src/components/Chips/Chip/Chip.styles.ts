import { createStyles, CeStyleNumberSize, CeStyleSize, CeStyleColor } from '@cestyle/styles';
...
export default createStyles((theme, { size, color }: ChipStylesParams, getRef) => ({
  root: {},
