...
describe('@cestyle/core/LoadingOverlay', () => {
  itSupportsSystemProps({
    component: LoadingOverlay,
    props: defaultProps,
    displayName: '@cestyle/core/LoadingOverlay',
  ...
  it('renders based on visible prop', () => {
    ...
    expect(notVisible.querySelector('.cestyle-LoadingOverlay-root')).toBe(null);
    expect(visible.querySelector('.cestyle-LoadingOverlay-root')).toBeInTheDocument();
  });
});
