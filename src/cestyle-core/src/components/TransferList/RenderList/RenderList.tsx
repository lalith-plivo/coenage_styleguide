...
import { DefaultProps, Selectors, CeStyleNumberSize } from '@cestyle/styles';
...
export function RenderList({
  ...
  return (
    <div className={cx(classes.transferList, className)}>
      {title && (
        <Text weight="semibold" className={classes.transferListTitle}>
          {title}
        </Text>
      )}
...
RenderList.displayName = '@cestyle/core/RenderList';
