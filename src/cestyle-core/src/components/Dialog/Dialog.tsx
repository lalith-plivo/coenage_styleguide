...
import { Transition, CeStyleTransition } from '../Transition';
...
export interface DialogProps
  extends Omit<DefaultProps<DialogStylesNames>, CeStyleStyleSystemSize>,
...
export function CeStyleDialog(props: DialogProps) {
  const {
    withCloseButton,
    onClose,
    position,
    ...
    ...others
  } = useCeStyleDefaultProps('Dialog', defaultProps, props);
...
Dialog.displayName = '@cestyle/core/Dialog';
