...
import { DEFAULT_THEME, CeStyleProvider } from '@cestyle/styles';
...
storiesOf('ColorSwatch', module)
  ...
  .add('Custom components', () => (
    <Group style={{ padding: 15 }}>
      ...
      <ColorSwatch color="#000" component="a" href="https://cestyle.dev" />
    </Group>
  ))
  .add('Default props on CeStyleProvider', () => (
    <CeStyleProvider defaultProps={{ ColorSwatch: { size: 100 } }}>
