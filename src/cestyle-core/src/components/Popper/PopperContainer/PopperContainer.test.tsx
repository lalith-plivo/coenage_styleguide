...
import { itRendersChildren, itSupportsClassName } from '@cestyle/tests';
import { PopperContainer } from './PopperContainer';

describe('@cestyle/core/PopperContainer', () => {
  ...
  it('has correct displayName', () => {
    expect(PopperContainer.displayName).toStrictEqual('@cestyle/core/PopperContainer');
  });
