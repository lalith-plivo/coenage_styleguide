...
import { useBooleanToggle, useUuid } from '@cestyle/hooks';
import {
  Selectors,
  DefaultProps,
  extractSystemStyles,
...
export const PasswordInput = forwardRef<HTMLInputElement, PasswordInputProps>(
  (props: PasswordInputProps, ref) => {
    const {
      ...
      errorProps,
      ...others
    } = useCeStyleDefaultProps('PasswordInput', defaultProps, props);
...
PasswordInput.displayName = '@cestyle/core/PasswordInput';
