...
describe('@cestyle/core/Accordion', () => {
  itSupportsSystemProps({
    component: Accordion,
    props: defaultProps,
    displayName: '@cestyle/core/Accordion',
  ...
  it('renders correct amount of items', () => {
    ...
    expect(container.querySelectorAll('.cestyle-Accordion-item')).toHaveLength(3);
  });
  ...
  it('filters out unexpected children', () => {
    ...
    expect(container.querySelectorAll('.cestyle-Accordion-item')).toHaveLength(2);
    expect(container.querySelectorAll('.cestyle-Button-root')).toHaveLength(0);
