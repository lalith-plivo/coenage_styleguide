...
export const Menu: MenuComponent = forwardRef<HTMLButtonElement, MenuProps>(
  (props: MenuProps, ref) => {
    const {
      ...
      clickOutsideEvents,
      ...others
    } = useCeStyleDefaultProps('Menu', defaultProps, props);
    ...
    const handleKeyDown = (event: React.KeyboardEvent<HTMLElement>) => {
      if (_opened) {
        const elements = Array.from(
          dropdownElement.querySelectorAll<HTMLButtonElement>('.cestyle-Menu-item')
        );
...
Menu.displayName = '@cestyle/core/Menu';
