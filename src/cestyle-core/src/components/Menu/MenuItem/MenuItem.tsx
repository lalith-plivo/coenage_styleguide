...
import { Selectors, PolymorphicComponentProps, DefaultProps, CeStyleColor } from '@cestyle/styles';
import { mergeRefs } from '@cestyle/hooks';
import { Box } from '../../Box';
...
export const _MenuItem = forwardRef(
  (
    ...
    const itemIndex = getContextItemIndex(
      { elementSelector: '.cestyle-Menu-item', parentClassName: 'cestyle-Menu-body' },
      itemRef.current
    );
...
MenuItem.displayName = '@cestyle/core/MenuItem';
