...
import { useScrollLock, useFocusTrap, useFocusReturn, useUuid } from '@cestyle/hooks';
import {
  DefaultProps,
  CeStyleNumberSize,
  CeStyleShadow,
...
export interface ModalProps
  extends Omit<DefaultProps<ModalStylesNames>, CeStyleStyleSystemSize>,
...
export function Modal(props: ModalProps) {
  const {
    ...
    ...others
  } = useCeStyleDefaultProps('Modal', defaultProps, props);
                  ...
                  <>
                    <Box p="lg">
                      <div className={classes.header}>
                        <Text id={titleId} className={classes.title} weight="semibold" size="lg">
                          {title}
                        </Text>
                        {withCloseButton && (
                          <CloseButton
...
Modal.displayName = '@cestyle/core/Modal';
