...
import { useUncontrolled, useDidUpdate, useMergedRef, useUuid } from '@cestyle/hooks';
import {
  DefaultProps,
  Selectors,
  extractSystemStyles,
...
export const Autocomplete = forwardRef<HTMLInputElement, AutocompleteProps>(
  (props: AutocompleteProps, ref) => {
    const {
      ...
      positionDependencies,
      ...others
    } = useCeStyleDefaultProps('Autocomplete', defaultProps, props);
      ...
      >
        ...
        >
          <Input<'input'>
            ...
            autoComplete="off"
            {...rest}
            data-cestyle-stop-propagation={dropdownOpened}
            required={required}
...
Autocomplete.displayName = '@cestyle/core/Autocomplete';
