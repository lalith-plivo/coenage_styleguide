...
describe('@cestyle/core/Image', () => {
  ...
  itSupportsSystemProps({
    component: Image,
    props: defaultProps,
    displayName: '@cestyle/core/Image',
  ...
  it('renders placeholder based on withPlaceholder prop', () => {
    ...
    expect(withPlaceholder.querySelectorAll('.cestyle-Image-placeholder')).toHaveLength(1);
    expect(withoutPlaceholder.querySelectorAll('.cestyle-Image-placeholder')).toHaveLength(0);
  });
