import { createStyles, CeStyleNumberSize, CeStyleColor } from '@cestyle/styles';
...
export default createStyles((theme, { size, variant, color }: DividerStylesParams) => ({
  ...
  horizontal: {
    ...
    borderTopColor: theme.fn.themeColor(color, theme.colorScheme === 'dark' ? 7 : 7, false),
  ...
  vertical: {
    ...
    borderLeftColor: theme.fn.themeColor(color, 7, false),
