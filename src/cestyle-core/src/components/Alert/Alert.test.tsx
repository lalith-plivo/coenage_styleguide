...
describe('@cestyle/core/Alert', () => {
  ...
  it('renders close button based on withCloseButton prop', () => {
    ...
    expect(withCloseButton.querySelector('.cestyle-Alert-closeButton')).toBeInTheDocument();
    expect(withoutCloseButton.querySelectorAll('.cestyle-Alert-closeButton')).toHaveLength(0);
  });
  ...
  it('does not render title if title prop was not passed', () => {
    ...
    expect(container.querySelectorAll('.cestyle-Alert-title')).toHaveLength(0);
  });
