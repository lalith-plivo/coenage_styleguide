...
describe('@cestyle/core/Select/SelectItems', () => {
  it('renders nothing found message if data array is empty', () => {
    ...
    expect(withData.querySelectorAll('.cestyle-Select-nothingFound')).toHaveLength(0);
    expect(withoutData.querySelector('.cestyle-Select-nothingFound').textContent).toBe(
      'test-nothing'
    );
  });
  ...
  it('has correct displayName', () => {
    expect(SelectItems.displayName).toStrictEqual('@cestyle/core/SelectItems');
  });
});
