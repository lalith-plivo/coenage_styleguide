...
describe('@cestyle/core/PopoverBody', () => {
  ...
  it('renders close button based on withCloseButton prop', () => {
    ...
    expect(withCloseButton.querySelectorAll('.cestyle-Popover-close')).toHaveLength(1);
    expect(withoutCloseButton.querySelectorAll('.cestyle-Popover-close')).toHaveLength(0);
  });
  ...
  it('has correct displayName', () => {
    expect(PopoverBody.displayName).toStrictEqual('@cestyle/core/PopoverBody');
  });
});
