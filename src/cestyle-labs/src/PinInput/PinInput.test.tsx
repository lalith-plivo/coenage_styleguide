...
describe('@cestyle/core/PinInput', () => {
  ...
  it('renders correct amount of inputs based on length prop', async () => {
    ...
    expect(container.querySelectorAll('.cestyle-PinInput-input')).toHaveLength(5);
  });
  ...
  it('fires onComplete method when last field is filled', async () => {
    ...
    const inputs = Array.from(container.getElementsByClassName('cestyle-PinInput-input'));
