...
import { CeStyleTheme } from '@cestyle/core';

export const dark = (theme: CeStyleTheme): PrismTheme => ({
  plain: {
...
export const light = (theme: CeStyleTheme): PrismTheme => ({
  plain: {
...
export const getPrismTheme = (theme: CeStyleTheme, colorScheme: 'light' | 'dark') =>
