...
export const Prism: PrismComponent = forwardRef<HTMLDivElement, PrismProps>(
  (props: PrismProps, ref) => {
    const {
      ...
      trim,
      ...others
    } = useCeStyleDefaultProps('Prism', prismDefaultProps, props);
...
export const PrismTabs = forwardRef<HTMLDivElement, PrismTabsProps>(
  (props: PrismTabsProps, ref) => {
    const { children, classNames, styles, ...others } = useCeStyleDefaultProps(
      'PrismTabs',
      {},
      props
    );
...
Prism.Tab = PrismTab;
Prism.displayName = '@cestyle/prism/Prism';
PrismTabs.displayName = '@cestyle/prism/Tabs';
PrismTab.displayName = '@cestyle/prism/Tab';
