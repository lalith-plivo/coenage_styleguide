...
export const NOTIFICATIONS_EVENTS = {
  show: 'cestyle:show-notification',
  hide: 'cestyle:hide-notification',
  update: 'cestyle:update-notification',
  clean: 'cestyle:clean-notifications',
  cleanQueue: 'cestyle:clean-notifications-queue',
} as const;
